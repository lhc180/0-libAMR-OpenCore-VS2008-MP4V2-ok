...
int main( int argc, char** argv )
{
 ...
 const char* const hello2 = "hello two";
  const char* const hello = "hello one";
    ...
    /* add bogus item to file */
    {
        ...
        bogus = MP4ItmfItemAlloc( "bogu", 1 );

        //const char* const hello = "hello one";

        data = &bogus->dataList.elements[0];
