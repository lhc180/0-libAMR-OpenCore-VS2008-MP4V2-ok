...
{
    if( fwrite( buffer, (size_t)size, 1, (FILE*)handle ) != 1)
        return 1;
    *nout = size;
    return 0;
}
...
int main( int argc, char** argv )
{
    ...
    /* open file for read */
     file = MP4ReadProvider( argv[1],   &provider );
